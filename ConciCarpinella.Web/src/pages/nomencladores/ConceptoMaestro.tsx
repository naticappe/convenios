        ...
        <div>
          <div className="flex flex-wrap gap-3 mb-5">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-sm border border-azul-oscuro rounded-lg hover:bg-azul/5 text-azul-oscuro transition-colors"
            >
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-slate-200" style={{ backgroundColor: '#8AB1CB' }}>
                    ...
                    <th className="text-left px-4 py-3 font-semibold text-white">Sigla</th>
        ...
        <div>
          <div className="flex flex-wrap gap-3 mb-5">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 text-sm border border-slate-200 rounded-lg hover:bg-slate-50 text-slate-500 font-medium"
            >
              <X size={14} />Limpiar
            </button>
          </div>
